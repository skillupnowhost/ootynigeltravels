...
import { createStaffUserAction, type AdminActionState } from "@/lib/actions/adminUsers";
...
export function StaffUserForm() {
  const [state, formAction, pending] = useActionState(createStaffUserAction, initial);
