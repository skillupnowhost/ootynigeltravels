...
export const metadata: Metadata = {
  title: "Best Ooty Taxi Service & Tour Packages | Ooty Nigel Travels",
  description:
    "Book the best Ooty taxi service, Coimbatore to Ooty cab, airport transfer, local sightseeing taxi and curated Ooty tour packages with Ooty Nigel Travels.",
  keywords: [
    "best Ooty taxi service",
